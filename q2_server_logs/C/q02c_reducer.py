...
text_file = open("q02c_answers.txt", "w")  # text with answers 
...
# only flush global max
# print(global_max_key, global_max, sep='\t')
text_file.write(global_max_key + '\t' + str(global_max))    
